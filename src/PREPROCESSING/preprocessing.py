...
class Preprocessing:
    def __init__(self,
        ...
        self.preprocess_images(self.picture_batch_)
    ...
    def preprocess_images(self, picture_batch):
        ...
        self.picture_batch_ = preprocessed_images

    def output_one_image(self):
        cv2.imwrite("Preprocessed.jpeg", self.picture_batch_[0])

#Testing whether preprocessing works
pictures_batch = dstack_folder(os.path.join("validation_data","5055540026268","VID36"))
